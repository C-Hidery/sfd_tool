...
std::string showFileChooser(GtkWindow* /*parent*/, bool /*open*/) { return std::string(); }
std::string showFolderChooser(GtkWindow* /*parent*/) { return std::string(); }
...
bool showConfirmDialog(GtkWindow* /*parent*/, const char* /*title*/, const char* /*message*/) { return false; }
...
bool isWindowDragging(GtkWindow* /*window*/) { return false; }
