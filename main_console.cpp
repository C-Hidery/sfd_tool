...
void print_help() {
	...
	DBG_LOG(
		...
		"\t13.r|read_part all|part_name|part_id\n"
		...
		"\t14.read_spec part_name|part_id offset size [FILE]\n"
...
int main_console(int argc, char** argv) {
	...
	printf("sfd_tool version 1.7.3.0 Console mode\n");
#if _DEBUG  
	...
	while (1) {
		...
		if (!strcmp(str2[1], "sendloop")) {
			...
			if (argcount <= 2) { DEG_LOG(W,"write_parts/write_parts_a/write_parts_b save_location\n"); argc = 1; continue; }
			int force_ab = 0;
